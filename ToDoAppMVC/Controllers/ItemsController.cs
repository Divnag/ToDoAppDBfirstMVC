...
namespace ToDoAppMVC.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemID,ItemName,ItemDescription,DueDate,IsDone,Priority,ListID")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemID,ItemName,ItemDescription,DueDate,IsDone,Priority,ListID")] Item item)
        {
            if (ModelState.IsValid)
            {
